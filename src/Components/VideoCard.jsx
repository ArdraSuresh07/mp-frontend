...
function VideoCard({video,setDeleteVideoResponse,insideCategory}) {
  ...
  // to view the details of watched videos in json server history
  ...
  return (
    ...
    <Card draggable onDragStart={e=>dragStarted(e,video?.id)}>
      ...
      <Card.Body>
        <Card.Title className='d-flex justify-content-between align-items-center'>Video Title
        <h5>{video?.caption}</h5>
    ...
    <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
        <iframe width="100%" height="300" src={`${video?.link}?autoplay=1`} title="Dune: Part Two | Rise |" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullscreen></iframe>
        </Modal.Body>
      </Modal>
    </>
  )
